    ...
    <header className="bg-white border-b border-[#E7E9EE] sticky top-0 z-30">
      <div className="max-w-6xl mx-auto px-5 h-14 flex items-center justify-between gap-3">
        ...
        >
          ...
          <span className="hidden sm:inline text-[#2A2E35]">미션 질문</span>
        </Link>

        <nav className="hidden md:flex items-center gap-6 text-sm">
          <Link href="/missions" className="text-[#5B6271] hover:text-[#0F1115]">
            주차별 미션
          </Link>
          <Link href="/skills" className="text-[#5B6271] hover:text-[#0F1115]">
            스킬 &amp; 인사이트
          </Link>
        </nav>
