...
export default function KoniCertificate() {
  const member = {
    ...
    realName: "황초롱",
    team: "3조",
    jobTitle: "마케터, AI 자동화 실험 중, 사이드 프로젝트 준비",
  ...
  const giftMessages = [
    { sender: "흐민", message: "고퀄리티의 삽질기까지 남겨주신 코니에게 감사한 마음을 전합니다" },
    { sender: "솔라", message: "고퀄 가이드 감사해요" },
  ...
  const timeline = [
    ...
    {
      week: "3주차", date: "5/24",
      title: "환자가 본 우리 병원 — 콘텐츠 진단 웹앱",
      summary: "원장님이 콘텐츠를 붙여넣으면 환자 관점에서 빈 키워드를 보여주는 웹앱을 만들었어요. v1(자가진단)→v2(전문가 진단)→v3(환자 시점)으로 두 번 갈아엎고, 처음으로 '나도 써보고 싶다'는 느낌이 들었어요.",
      insight: "인하우스에서 일하면 '모르는 사람한테 팔리는 것' 만드는 감각이 무뎌진다.",
    },
    {
      week: "4주차", date: "5/31",
      title: "와인 웹앱 v2 — 앱이 먼저 말 거는 방향으로",
      summary: "판독기를 접고 와인 웹앱을 다시 꺼냈어요. AI가 세 군데서 한 줄을 건네는 '앱이 먼저 말 거는' 방향으로 전환. 두 대 PC 연속성을 위해 하네스·워크로그를 GitHub 문서로 옮겼어요.",
      insight: "만들었다고 다 쓰는 게 아니다. 기존 앱이 안 하는 것으로 방향을 틀어야 한다.",
    },
    {
      week: "5주차", date: "6/7",
      title: "와인 취향 통역기 — 기획 재설계",
      summary: "기존 풀버전 와인 앱을 접고 '와인 취향 통역기'로 처음부터 재설계했어요. 일상어 감각을 와인 가게에서 써먹을 수 있는 취향의 언어로 번역해주는 서비스. 취향/묘사/결함 3갈래 번역 구조를 설계했어요.",
      insight: "완성도와 서비스는 다르다. 나한테 완벽한 앱이 남에게도 완벽한 건 아니다.",
    },
  ];
