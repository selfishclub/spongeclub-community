...
export default function SlowquickCertificate() {
  ...
  const character = {
    ...
    description:
      "오프라인에서 \"경력 단절 기간이 길었고, 과부하로 3~4주 학습이 정체됐다\"고 솔직하게 밝혔다. 개발자 남편에게 배운 '정본' 방법론으로 돌파구를 만들고, 화요일 자체 공유회를 열었어요. 1주차에 블로그 플랫폼을, 2주차엔 Sullivan 사고 파트너 시스템을 텔레그램 봇으로 연결하며, \"봇 만들기와 시스템 연결은 완전히 다른 단계\"라는 핵심 학습을 했어요.",
  };
  ...
  const badges = [
    ...
    { name: "이기적 올라운더", icon: "/badges/all-rounder.svg" },
  ];
  ...
  const giftMessages = [
    { sender: "에밀리", message: "스킬러스 채널에 후기가득한 공유 감사드려요!" },
    { sender: "포노미터", message: "즐거운 토요일 되세요!!" },
  ];
