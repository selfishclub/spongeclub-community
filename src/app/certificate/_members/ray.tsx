...
export default function RayCertificate() {
  ...
  const giftMessages = [
    ...
    { sender: "Galia", message: "같은 조로서 응원하는 마음으로 보냅니다! 화이팅!!" },
  ];
