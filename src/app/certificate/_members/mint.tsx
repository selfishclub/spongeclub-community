...
export default function MintCertificate() {
  ...
  const giftMessages = [
    { sender: "이든", message: "친근하게 먼저 인사해주시고 셸 보내주시고 고마워용 민트~~" },
    { sender: "아가타", message: "멋져요" },
    { sender: "아가타", message: "토요팅팅" },
    { sender: "아가타", message: "6월 화이팅팅!" },
  ];
