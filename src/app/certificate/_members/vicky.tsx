...
export default function VickyCertificate() {
  const member = {
    ...
    realName: "서승리",
    team: "5조",
    jobTitle: "1인 대표 (일본 Qoo10JP, AmazonJP 운영대행)",
  ...
  const giftMessages = [
    { sender: "오웬", message: "보고싶은 비키에게 오늘의 셸을 보냅니다" },
  ...
  const timeline = [
    ...
    {
      week: "4주차", date: "5/31",
      title: "Qoo10 광고 효율 분석 메뉴 추가",
      summary: "키워드 추적 도구에 광고 효율 분석 메뉴를 붙였어요. CSV 3종 업로드로 CPC·ROAS·컷오프를 자동 계산하고, 낙찰현황·광고 퍼널·상품매핑까지 4개 탭 구조로 확장했어요.",
    },
    {
      week: "5주차", date: "6/7",
      title: "Qoo10 리뷰 분석 + 수집 캘린더 + 엑셀 자동저장",
      summary: "상품 URL로 리뷰를 자동 분석하는 메뉴, 이벤트 검색수 수집 기능, 월간/연간 수집 캘린더, 엑셀 자동 저장을 추가했어요. 복합명사 인식 오류와 수집 프로세스 끊김 버그도 잡았어요.",
      insight: "기능보다 정의를 먼저 확실하게 — 기준(축)을 처음부터 안 정하면 나중에 겉잡을 수 없이 꼬인다.",
    },
  ];
      ...
      {hasDiploma && (
        <section className="bg-[var(--ink-05)] border-b border-[var(--ink-10)]">
          <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
            <div className="bg-[#FFFBEB] border-2 border-[#F59E0B] p-8 md:p-12 text-center relative"><RankBadge memberName="비키(서승리)" />
