...
export default function YuliaCertificate() {
  ...
  const badges = [
    ...
    { name: "첫 공유회 오픈", icon: "/badges/first-session-host.svg", earned: "2026.06" },
    { name: "첫 크루챗", icon: "/badges/first-crewchat.svg", earned: "2026.06" },
    { name: "셸 인기스타", icon: "/badges/shell-superstar.svg", earned: "2026.06" },
  ];

  const giftMessages = [
    { sender: "Nina", message: "오늘이 가기 전에 셸 선물 완료!" },
    { sender: "Nina", message: "미니 강의도 열어주시고 너무 즐거운 시간이었습니다" },
      ...
      {hasDiploma && (
        <section className="bg-[var(--ink-05)] border-b border-[var(--ink-10)]">
          <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
            <div className="bg-[#FFFBEB] border-2 border-[#F59E0B] p-8 md:p-12 text-center relative"><RankBadge memberName="율리아(조유리)" />
