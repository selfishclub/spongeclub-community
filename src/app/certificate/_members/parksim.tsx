...
export default function ParksimCertificate() {
  ...
  const timeline = [
    {
      week: "1주차", date: "5/10",
      title: "CPA 블로그 자동 브리핑 스킬",
      summary: "여행 CPA 블로그의 병목인 \"리서치 페이즈\"를 해결하기 위해, 여행 사이트별 프로모션을 자동 수집하고 오늘 다룰 추천 후보를 1장으로 요약해주는 cpa-daily-brief 스킬을 만들었어요.",
      insight: "나는 판단·선택만 하고, 나머지는 시스템이 한다.",
    },
    {
      week: "3주차", date: "5/24",
      title: "알뜰폰 비교 도구 — altpon-deal",
      summary: "알뜰폰 갈아탈 때 이미지에 박힌 프로모션을 일일이 비교하는 게 귀찮아서, 헬로모바일/KT M/유모바일 3사를 \"실질 이익\" 기준으로 비교하는 웹 도구를 만들어 GitHub Pages에 배포했어요.",
      insight: "혜택 총액이 큰 곳이 1위가 아니에요. 유지 기간이 짧을수록 기간당 혜택 밀도가 높을수록 이익이 커요.",
    },
    {
      week: "5주차", date: "6/7",
      title: "알뜰폰 도구 전면 재설계 — 친구 피드백 반영",
      summary: "친구 5명에게 피드백을 받아 메인 화면과 결과 화면을 전면 재설계했어요. 페이지 전환을 아코디언 펼침으로 바꾸고, 키비주얼·혜택 표기·가입 동선을 처음부터 다시 만들었어요. 정적 비교표 → 동적 추천 → 사용자 피드백 반영 도구로 진화한 3주간의 여정이에요.",
      insight: "카피 하나에 한 시간. 숫자 정직성 vs 임팩트 충돌에서 '최대 47만원'으로 합의 — 정직성 보존하면서 임팩트를 살렸어요.",
    },
  ];

  const beforeAfter = {
    before: "단순 채팅으로 끝나는 부분.",
    after: "CPA 브리핑 스킬 → 알뜰폰 비교 도구 → 친구 피드백 반영 재설계까지. 채팅을 넘어 실제 도구를 만들고, 피드백을 받고, 개선하는 사이클을 직접 돌린 사람이에요.",
  };
