...
export default function ParksimCertificate() {
  ...
  const character = {
    type: "충분한 논의 후 시작하는 크루",
    image: "/certificate/character-cheerleader.svg",
    description:
      "1, 2, 3주차 과제를 제출하며 cpa-daily-brief Claude Skill로 CPA 블로그 추천 여행 콘텐츠를 자동 브리핑하는 스킬을 만들고, 2-3주차에 여행 블로그 시리즈물 기획으로 확장했어요. \"충분한 논의 필요 -- 무작정 코드부터 시작하지 말기\"라는 교훈을 남긴 사람이에요. 셸 35개 보내기, SNS 22회, VOD 7개 구매 -- 모든 숫자가 전체 멤버 최상위권이에요.",
  };
  ...
  const badges = [
    ...
    { name: "VOD 큰 손", icon: "/badges/vod-big-hand.svg", earned: "2026.06" },
    { name: "SNS 인플루언서", icon: "/badges/sns-influencer.svg", earned: "2026.06" },
    { name: "공유회 단골손님", icon: "/badges/session-regular.svg", earned: "2026.06" },
  ];

  const giftMessages = [
    { sender: "키노", message: "오늘의 MVP 축하드려요!" },
    { sender: "보미", message: "과제 공유에서 영감 받음!" },
    { sender: "오웬", message: "다시보기까지 결제해서 리모션 스킬 따라 온 상임의 열정에 박수를 보내요!!" },
  ];

  const timeline = [
    {
      week: "1주차", date: "5/10",
      title: "cpa-daily-brief Claude Skill — CPA 블로그 추천 여행 콘텐츠",
      summary: "여행 CPA 블로그의 병목인 \"리서치 페이즈\"를 해결하기 위해, 여행 사이트별 프로모션을 자동 수집하고 오늘 다룰 추천 후보를 1장으로 요약해주는 cpa-daily-brief 스킬을 만들었어요.",
      insight: "충분한 논의 필요 -- 무작정 코드부터 시작하지 말기.",
    },
    {
      week: "2주차", date: "5/17",
      title: "여행 블로그 시리즈물 기획 확장",
      summary: "1주차 CPA 블로그 브리핑 스킬을 기반으로 여행 블로그 시리즈물 기획으로 확장했어요.",
    },
    {
      week: "3주차", date: "5/24",
      title: "여행 블로그 시리즈물 기획 심화",
      summary: "여행 블로그 시리즈물 기획을 더 구체화하며 콘텐츠 제작 워크플로우를 다듬었어요.",
    },
    {
      week: "4주차", date: "5/31",
      title: "알뜰폰 비교 도구 — OCR 삽질에서 사용자 피드백 반영까지",
      summary: "워크로그 자동화 스킬을 옵시디언에 구축하고, 알뜰폰 비교 도구를 개선했어요. OCR 실험을 시도했지만 과하다고 판단해 손정리로 전환. 친구 피드백 \"그래서 어디가 돈 많이 줘?\"로 구조를 통째 재설계하고, 헬로모바일 7요금제+6혜택을 확정해 GitHub Pages에 배포했어요.",
      insight: "진짜 병목은 데이터를 옮기는 게 아니라 뭐가 의미 있는지 판단하는 것.",
    },
    {
      week: "5주차", date: "6/7",
      title: "알뜰폰 비교 도구 — 친구 피드백 5개 반영 전면 재설계",
      summary: "친구 피드백 5개를 받아 메인+결과 화면을 전면 재설계했어요. 페이지 전환을 아코디언 펼침으로 바꾸고, 키비주얼 \"최대 47만원\", 1위 풀 디테일+나머지 한 줄 압축, 가입 버튼 빨간색으로 위계 정리. 카피 하나에 1시간 쓰는 삽질도.",
      insight: "내가 정리한 방식과 내가 추천하는 방식은 다르다. 사용자 행동을 관찰하면 진짜 니즈가 보인다.",
    },
    {
      week: "6주차", date: "6/14",
      title: "알뜰폰 비교 도구 최종 배포 + SNS 미니유닛",
      summary: "최종 산출물을 갤러리에 등록하고, 키노의 카드뉴스 OS로 7주간 일정을 카드뉴스로 정리해 인스타 4개+블로그 1개+쓰레드 1개를 업로드했어요.",
    },
  ];

  const beforeAfter = {
    before: "단순 채팅으로 끝나는 부분",
    after: "cpa-daily-brief 스킬에서 시작해 여행 블로그 시리즈물 기획까지 확장했어요. \"충분한 논의 후 시작하기\"라는 원칙을 세우며, 단순 채팅을 넘어 실제 콘텐츠 파이프라인을 만든 사람이에요.",
  };
      ...
      {hasDiploma && (
        <section className="bg-[var(--ink-05)] border-b border-[var(--ink-10)]">
          <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
            <div className="bg-[#FFFBEB] border-2 border-[#F59E0B] p-8 md:p-12 text-center relative"><RankBadge memberName="박상임" />
