...
export default function AceCertificate() {
  ...
  const character = {
    ...
    description:
      "오프라인에서 강의 자료를 PPT 대신 HTML 사이트로 제작하는 방식으로 전환했다고 밝혔다. 책 집필 중이며, AI를 사용하지 않는 오프라인 글쓰기 합평 모임도 추진 중. \"막히는 지점을 좀더 쉽게 설명하고 끝까지 완주하는 사람\"으로 기억되고 싶다고 했어요.",
  };
  ...
  const giftMessages = [
    { sender: "지니", message: "에이스님 옵시디언 도와주셔서 감사합니다" },
    { sender: "박루아", message: "아직 부족한데, 구체적인 피드백 넘 감사합니다." },
  ];

  const beforeAfter = {
    before: "아이디어를 실제 결과물로 구현하는 과정에서 프롬프트 설계와 수정 반복을 줄이고 싶다.",
