...
export default function DuksuCertificate() {
  ...
  const timeline = [
    ...
    {
      week: "2주차", date: "5/17",
      title: "브랜드 스타트 키트 — 유아용품 사이드 프로젝트 설계",
      summary: "디자이너로서 유아용품 시장의 편의성 부족이라는 문제의식에서 출발해, 제품의 비주얼/퀄리티 디렉팅만 하고 나머지는 시스템이 해주는 OS를 목표로 설정했어요. 브랜딩을 웹페이지로 제안하는 키트를 구상하고 localhost 기반 프로토타입을 구성했어요.",
    },
    {
      week: "3주차", date: "5/24",
      title: "Facette — 디자이너용 패싯 레퍼런스 아카이브",
      summary: "핀터레스트가 못 하는 다축 교차검색을 핵심으로, 디자이너 전용 레퍼런스 아카이브 Facette를 만들었어요. 코디 추천 앱 등 여러 안을 엎고, 동료 인터뷰에서 진짜 통점을 잡아 방향을 재정의했어요. AI 자동태깅 없이 localStorage + 수동 태그만으로 핵심 가치를 검증했어요.",
      insight: "만들기보다 고객/통점 좁히기가 진짜 작업이다. 만들기 전 동료 10분 인터뷰가 방향을 구했다.",
    },
  ];
      ...
      {hasDiploma && (
        <section className="bg-[var(--ink-05)] border-b border-[var(--ink-10)]">
          <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
            <div className="bg-[#FFFBEB] border-2 border-[#F59E0B] p-8 md:p-12 text-center relative"><RankBadge memberName="덕수(김효정)" />
