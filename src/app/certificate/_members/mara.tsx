...
export default function MaraCertificate() {
  ...
  const timeline = [
    {
      week: "1주차",
      date: "5/10",
      title: "시장 고점 감정 분석 + 세컨드 브레인",
      summary:
        "투자팀 10명을 위해 실시간 뉴스 댓글 감정 분석으로 시장 고점을 판별하는 기능을 개발. 세컨드 브레인 시스템(Karakeep→Claude→Notion)으로 콘텐츠 아이디어 일일 3개 자동 추출.",
  ...
  const beforeAfter = {
    before:
      "클로드 코드의 경우 소소하게 버그를 고칠 게 많아서 은근 손이 많이 가요.",
    after:
