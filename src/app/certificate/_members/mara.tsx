...
export default function MaraCertificate() {
  const member = {
    ...
    realName: "마라",
    team: "2조",
    jobTitle: "스타트업 마케팅 경력, 현재 휴직 중",
    period: "2026.05.03 — 2026.06.14",
  };

  const character = {
    type: "ETF 80개를 8,408개로 확장한 크루",
    image: "/certificate/character-connector.svg",
    description:
      "1주차에 ETF 시장 심리 분석기(뉴스 댓글→투자자 감정→리포트)를 만들고, 2주차엔 80개였던 ETF DB를 8,408개까지 확장해 A-E 5단계 신호, 11개 명령어 텔레그램 봇, 30분 간격 자동 스크리닝 시스템을 완성했어요. 3-4주차에는 커뮤니티 로드맵 생성 도구를 실사용자 테스트까지 진행. 매주 빠짐없이 과제를 제출하며 \"거의 다 완성해가고 있어요!\"라고 말할 수 있는 사람이 되었어요.",
  };
  ...
  const timeline = [
    {
      week: "1주차",
      date: "5/10",
      title: "ETF 시장 심리 분석기 + 세컨드 브레인",
      summary:
        "뉴스 댓글 수집→투자자 감정 분석→HTML 리포트를 자동 생성하는 ETF 시장 심리 분석기를 개발. Karakeep→Claude→Notion 파이프라인으로 세컨드 브레인 시스템도 구축.",
      insight: "\"너는 어떻게 생각해?\"라는 질문이 게임 체인저였다.",
    },
    {
      week: "2주차",
      date: "5/17",
      title: "글로벌 ETF 자동 스크리너",
      summary:
        "80개에서 8,408개로 ETF DB를 확장. A-E 5단계 신호 체계, 11개 명령어 텔레그램 봇, 30분 간격 자동 스크리닝 시스템을 완성했어요.",
    },
    {
      week: "3주차",
      date: "5/24",
      title: "커뮤니티 로드맵 생성 도구",
      summary:
        "커뮤니티를 위한 로드맵 생성 도구를 설계. 실사용자 테스트에서 구글시트를 더 선호한다는 발견을 했어요.",
    },
    {
      week: "4주차",
      date: "5/31",
      title: "커뮤니티 피드백 기반 제품 개선",
      summary:
        "3주차 실사용자 피드백을 반영해 커뮤니티 제품을 개선. 사용자 선호에 맞춰 방향을 조정했어요.",
    },
    {
      week: "5주차",
      date: "6/7",
      title: "제품 완성 마무리",
      summary:
        "\"거의 다 완성해가고 있어요!\" 지속적으로 다듬으며 완성도를 높이는 단계에 진입했어요.",
    },
  ];

  const giftMessages = [
    { sender: "포노미터", message: "반가워요~" },
    { sender: "Hook2", message: "마라 이번에도 열심히 화이팅해봅시다!" },
    { sender: "에밀리", message: "항상 열심히 탐험단 활동을 해주시는 마라님 ㅎㅎ" },
  ];

  const beforeAfter = {
    before: "클로드 코드의 경우에 뚝딱 만들어주는 듯 하면서도 소소하게 버그를 고칠 게 많아서 은근 손이 많이 가는 점",
    after:
      "ETF 80개를 8,408개로 확장하고, 텔레그램 봇으로 30분마다 자동 스크리닝하는 시스템을 만들었어요. 버그를 고치는 데 그치지 않고, 매주 과제를 빠짐없이 제출하며 자기 프로덕트를 완성해간 사람이에요.",
  };
