...
export default function ArtreeCertificate() {
  ...
  const character = {
    ...
    description:
      "오프라인에서 \"15명 규모 법인을 운영하며 하고 싶은 프로젝트와 경영 관리 사이의 균형이 키워드\"라고 밝혔다. AI 자동화로 경영 관리 부담을 줄여 원하는 프로젝트에 집중하고 싶다고. 암묵지를 형식지로 전환하는 경험이 유익했다고 말한 사람이에요.",
  };
