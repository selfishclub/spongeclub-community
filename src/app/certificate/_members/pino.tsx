...
export default function PinoCertificate() {
  ...
  const timeline = [
    ...
    },
    {
      week: "2주차",
      date: "5/17",
      title: "OS 인터뷰 — 아침 브리핑 스킬 설치 + OS 선언문",
      summary: "os-interview-skill로 40분 인터뷰를 진행해 OS 선언문과 아침 브리핑 스킬을 만들었어요. 통점 분석에서 \"상사 구두 지시 시 시작 전 결정 비용\"이 가장 크다는 걸 발견하고, 6개 후보 중 아침 할 일 요약을 첫 부품으로 선택했어요.",
      insight: "다 해야 한다는 막연함에서 첫 부품 1개로 좁혀지는 과정이 핵심이었다.",
    },
    {
      week: "3주차",
      date: "5/24",
