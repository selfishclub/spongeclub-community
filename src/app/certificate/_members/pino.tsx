...
export default function PinoCertificate() {
  ...
  const character = {
    ...
    description:
      "1주차에 OS 인터뷰를 통해 아침 브리핑 스킬을 만들며 \"누구에게 무엇을 어떻게 전달할지만 결정, 나머지는 시스템이\"라는 원칙을 세웠어요. 3주차엔 Google Sheets + AppSheet 조합으로 반복업무 자동생성기, 모바일 체크리스트, 마감알림 대시보드까지 3종 업무관리 시스템을 완성. \"개념부터가 아닌, 만들고 나서 정의가 더 이해 잘 됨\"이라는 인사이트를 남긴 사람이에요.",
  };
  ...
  const timeline = [
    {
      week: "1주차",
      date: "5/10",
      title: "OS 인터뷰 + 아침 브리핑 스킬",
      summary:
        "OS 인터뷰를 통해 아침 브리핑 스킬을 만들었어요. \"누구에게 무엇을 어떻게 전달할지만 결정, 나머지는 시스템이\" 하는 원칙을 세웠어요.",
      insight: "누구에게 무엇을 어떻게 전달할지만 결정하면 된다.",
    },
    {
      week: "3주차",
      date: "5/24",
      title: "3종 업무관리 시스템",
      summary:
        "반복업무 자동생성기 + 모바일 체크리스트 + 마감알림 대시보드, 세 가지를 Google Sheets + AppSheet 조합으로 완성했어요.",
      insight: "개념부터가 아닌, 만들고 나서 정의가 더 이해 잘 됨.",
    },
  ];
  ...
  const beforeAfter = {
    before: `어디서부터 시작하는게 맞는지 결정하는게 쉽지않음. 결과물이 맘에 들지 않을경우 확연히 나아지게 수정이 쉽지않다고 생각됨.\n`,
    after:
      "아침 브리핑 스킬에서 시작해 3종 업무관리 시스템까지 완성했어요. \"만들고 나서 정의가 더 이해 잘 됨\"이라는 자신만의 방법론을 발견한 사람이에요.",
  };
