...
export default function ModakCertificate() {
  ...
  const character = {
    ...
    description:
      "\"보안 및 저작권 허용 범위 지키기\"와 \"활용 아이디어 부족\"이 막힌 점이었어요. 그런데 2주차에 콘텐츠 제작 OS 3계층 아키텍처를 만들어 MVP로 뽑혔다. 5주차엔 AI 글 감별기 SaaS를 출시하며 \"말투는 기능이다\"라는 발견까지 했어요. 아이디어가 부족한 게 아니라, 데이터 구조가 잡히면 아이디어가 따라오는 사람이었어요.",
  };
  ...
  const timeline = [
    {
      week: "1주차", date: "5/10",
      title: "모닝 브리프 플러그인 설계",
      summary: "OS 선언문을 세우고 첫 부품으로 모닝 브리프 Claude Code 플러그인을 설계했어요. \"나는 만드는 일만 하고, 나머지는 시스템이 한다.\"",
    },
    {
      week: "2주차", date: "5/17",
      title: "콘텐츠 제작 OS — MVP 수상",
      summary: "3계층 아키텍처(Storage/Processing/Output)로 콘텐츠 제작 OS를 구현했어요. 캐러셀 스튜디오 v5까지 5번 반복하며 Single Source of Truth 원칙을 적용. 이 주차에 MVP로 선정됐어요.",
      insight: "OS의 핵심은 데이터 구조다 — 데이터 흐름이 잡히면 기능은 따라온다.",
    },
    {
      week: "5주차", date: "6/7",
  ...
  const giftMessages = [
    { sender: "Amy", message: "MVP로 뽑아주셔서 정말 감사합니다. 이 감사함을 함께하고자 셸을 보내봅니다!" },
    { sender: "잭", message: "우와 감사합니다 !!!!! 평안한 밤 되세요" },
    { sender: "배짱", message: "아자아자 퐈이탱!" },
    { sender: "배짱", message: "힘찬하루&한주되세요!! 퐈이탱!!" },
  ];
