...
export default function ParkRuaCertificate() {
  ...
  const character = {
    ...
    description:
      "오프라인에서 닉네임을 '나로'로 바꿨다고 밝혔다. 15년간 연인을 뒷바라지하다 사별 후 자신을 돌아보기 시작했다는 배경을 나누며, 크루들에게 깊은 인상을 남겼어요. '시오릴일일' 브랜드를 론칭하고, 디자인에 마케팅·기획 역량을 더하기 위해 참여.",
  };
  ...
  const giftMessages = [
    ...
    { sender: "다다", message: "에너지있는 오후 보내시길 바라요!" },
  ];
