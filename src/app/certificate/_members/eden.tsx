...
export default function EdenCertificate() {
  ...
  const timeline = [
    ...
    {
      week: "2주차", date: "5/17",
      title: "ADHD OS — 나만의 운영체제 정의",
      summary: "ADHD를 잘 다룰 수 있는 나만의 OS를 정의하고 구현을 시작했어요. 비용이 많이 들어가는 것에 놀라면서도 일단 해보자는 마인드로 도전했어요.",
    },
    {
      week: "3주차", date: "5/24",
