...
export default function HiyamCertificate() {
  ...
  const giftMessages = [
    ...
    { sender: "다니", message: "이번주도 화이팅입니당" },
    { sender: "석영", message: "이번주도 화이팅하세요!!" },
  ];
