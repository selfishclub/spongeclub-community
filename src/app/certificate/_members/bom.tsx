...
export default function BomCertificate() {
  ...
  const character = {
    ...
    description:
      "1주차에 콘텐츠 마케팅 자동화 OS를 시도했지만 회사 접근 제한으로 어려움을 겪었어요. 하지만 2주차에 캐러셀 OS를 Vercel에 배포하고 텔레그램 봇까지 연결했고, 3주차엔 그 OS를 활용해 데굴데굴 콘텐츠 캐러셀을 완성했어요. 5주차에는 오프라인 모임 사진 관리와 인스타그램 회고 글까지. \"아직 개인의 why를 찾는 중\"이라고 했지만, 매주 점진적으로 성장한 사람이에요.",
  };
  ...
  const timeline = [
    {
      week: "1주차",
      date: "5/10",
      title: "콘텐츠 마케팅 자동화 OS 시도",
      summary:
        "콘텐츠 마케팅 자동화 OS를 시도했지만 회사 접근 제한으로 어려움을 겪었어요. 방향을 재설정하는 계기가 되었어요.",
    },
    {
      week: "2주차",
      date: "5/17",
      title: "캐러셀 OS (Vercel 배포)",
      summary:
        "캐러셀 OS를 Vercel에 배포하고 텔레그램 봇, 데스크톱 바로가기까지 연결했어요. \"디자인 시스템 문서가 선결 조건\"이라는 발견.",
      insight: "디자인 시스템 문서가 선결 조건이다.",
    },
    {
      week: "3주차",
      date: "5/24",
      title: "데굴데굴 콘텐츠 캐러셀",
      summary:
        "이전 주에 만든 캐러셀 OS를 활용해 데굴데굴 콘텐츠 캐러셀을 완성. mp4와 png 내보내기 기능까지 구현했어요.",
    },
    {
      week: "5주차",
      date: "6/7",
      title: "오프라인 모임 사진 관리 + 회고",
      summary:
        "오프라인 모임 사진 관리와 인스타그램 회고 글을 작성. 매주 점진적으로 성장하는 과정을 기록했어요.",
    },
  ];
  ...
  const beforeAfter = {
    before: "아직 메시지 문구 콘텐츠 초안 작성 정도로만 활용해서 경험이 많지 않고, 서비스 결에 맞는 톤을 찾는게 몇번의 작업을 거쳐야해서 생각보다 시간이 소요됐습니다",
    after:
      "캐러셀 OS를 Vercel에 배포하고, 콘텐츠 캐러셀을 완성하고, SNS 인증 12회와 셸 22개를 보냈어요. \"아직 why를 찾는 중\"이라고 했지만, 매주 점진적으로 나아진 결과물이 그 증거예요.",
  };
