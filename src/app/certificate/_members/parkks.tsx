...
export default function ParkKSCertificate() {
  ...
  const character = {
    type: "매주 새 프로덕트를 만든 크루",
    image: "/certificate/character-builder.svg",
    description:
      "2주차부터 매주 새로운 웹앱을 완성했어요. '집다움 OS' 캐러셀 자동화에서 시작해, 리모델링 사전 상담 도구, Space FIT 스타일 진단 웹앱, 모임온(정기모임 운영 플랫폼)까지. 5주차에는 Claude Design으로 전면 디자인 개편까지 해냈어요. \"디자인시안은 최종스펙이 아니다\", \"WHY가 안 잡히면 클로드도 텍스트 자판기\"라는 인사이트를 가장 꾸준한 고급 구현으로 증명한 사람이에요.",
  };
  ...
  const timeline = [
    {
      week: "2주차", date: "5/17",
      title: "집다움 OS — 인스타 캐러셀 콘텐츠 자동화",
      summary: "6개 이상 도구에 흩어져 있던 인스타그램 캐러셀 제작 워크플로우를 하나의 웹앱으로 통합했어요. 주제 선택부터 PNG 내보내기까지 한 번에 가능하게 만들었어요.",
    },
    {
      week: "3주차", date: "5/24",
      title: "집다움 발굴 인터뷰 앱",
      summary: "리모델링 전 상담을 준비하는 고객을 위한 대화형 인터페이스를 만들었어요. WHY가 불명확하면 Claude Code도 텍스트 자판기일 뿐이라는 인사이트를 얻었어요.",
    },
    {
      week: "4주차", date: "5/31",
      title: "Space FIT — 집다움 스타일 진단 웹앱",
      summary: "5~7개 질문으로 개인 스타일·예산·업체 적합도를 진단해주는 웹앱. 규칙 기반 점수 시스템으로 안정적인 진단 결과를 구현했어요.",
    },
    {
      week: "5주차", date: "6/7",
      title: "모임온 — 정기모임 운영 웹앱",
      summary: "회원관리·출석·식대·회계·AI포스터까지 갖춘 정기 모임 운영 웹앱. Claude Design으로 전면 디자인 개편하면서 기존 기능은 100% 유지했어요.",
      insight: "디자인시안은 최종스펙이 아니다.",
    },
  ];
  ...
  const beforeAfter = {
    before: "결과를 내기위한 프롬프트 작성.",
    after:
      "집다움 OS, 발굴 인터뷰 앱, Space FIT, 모임온까지 — 2주차부터 매주 새로운 웹앱을 완성했어요. 프롬프트가 아니라 WHY가 핵심이라는 걸 발견하고, Claude Design으로 전면 디자인 개편까지 해낸 가장 꾸준한 고급 구현자.",
  };
