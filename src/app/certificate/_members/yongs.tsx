...
export default function YongsCertificate() {
  const member = {
    ...
    realName: "전용규",
    team: "4조",
    jobTitle: "글로벌 세일즈 경력, 법인 설립 준비 중",
  ...
  const giftMessages = [
    { sender: "다다", message: "옵시디언 노트 이름 바로 바꿔주셔서 감사해용!!!!" },
    { sender: "먼지민", message: "어제도 고생 많으셨습니다. 공유 발표도 감사해요" },
    { sender: "artree", message: "오프모임에서 위로를 많이 얻었어요. 감사한 마음 담아 보내요~" },
  ];
