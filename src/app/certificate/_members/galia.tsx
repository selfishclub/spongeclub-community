...
export default function GaliaCertificate() {
  ...
  const giftMessages = [
    ...
    { sender: "다니", message: "조용한 6조 스레드에서 항상 인사이트 나눠주셔서 감사합니닷!" },
    { sender: "J", message: "좋은 꿀팁 전수 감사합니다." },
  ];
