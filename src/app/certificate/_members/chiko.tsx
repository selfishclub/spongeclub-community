...
export default function ChikoCertificate() {
  ...
  const character = {
    ...
    description:
      "오프라인에서 솔리반을 참고해 7개의 에이전트를 완성했다고 밝혔다. 링크드인·블로그·인스타 3개 채널 콘텐츠가 자동으로 생성되는 시스템을 구축. 센세 페르소나 기반 브랜드 전략과 피그마 방식 수정 패널까지. 셸 28개를 받으며 크루들에게 강한 인상을 남겼어요.",
  };
  ...
  const giftMessages = [
    { sender: "Nina", message: "홈페이지 gif 너무 귀엽고 센스 있어서 자주 구경하고 있습니다" },
    { sender: "솔라", message: "오늘의 3조 MVP 치코!!! 최고에요" },
