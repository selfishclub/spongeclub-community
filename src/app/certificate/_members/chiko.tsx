...
export default function ChikoCertificate() {
  ...
  const timeline = [
    ...
    {
      week: "4주차", date: "5/31",
      title: "센세 생태계 — 생각정리 봇 에이전트 설계",
      summary: "개인용 생각정리 봇을 7개 에이전트(센세·BI·분석가·라이브러리·인사이트·워크인사이트·에디터)로 구성된 컨베이어 벨트 구조로 설계했어요. 텔레그램 입력에서 옵시디언 기록, 클러스터링, 위키화, 인사이트 발견, 콘텐츠 발행까지의 파이프라인을 구축했어요.",
      insight: "에이전트마다 '안 하는 일'을 명확히 정해야 전체가 돌아간다.",
    },
    {
      week: "5주차", date: "6/7",
      title: "이기적 공유 프로덕트 마무리 + SNS 인증",
      summary: "센세 생태계 프로덕트를 발표용으로 정리하고, 인스타그램 릴스로 SNS 인증까지 완료했어요.",
    },
  ];
