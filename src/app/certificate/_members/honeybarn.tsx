...
export default function HoneybarnCertificate() {
  ...
  const giftMessages = [
    ...
    { sender: "하늘", message: "화이팅입니다" },
    { sender: "Galia", message: "파이팅입니다!!!" },
  ];
