...
export default function RoykangCertificate() {
  ...
  const giftMessages = [
    { sender: "키노", message: "이기적공유회 너무나 꿀팁들을 가감없이 풀어주신 로이캉에게 감사의셸을..!" },
    { sender: "비키", message: "로이캉님 공유회 셸로 구매해서 VOD로 보고있습니다~! 좋은 정보 공유 감사드려요~!" },
    { sender: "이든", message: "이기적공유회에서 들려주신 내용들 최근 가장 고민이 많았던 지점이라 너무 좋았습니다" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[var(--paper)]">
      ...
      <footer className="py-14 text-center bg-[var(--yellow)]">
        ...
        <p className="text-sm font-extrabold text-[var(--ink)]">{member.name}, 스폰지클럽 1기와 함께했습니다.</p>
      </footer>
    </div>
  );
}
