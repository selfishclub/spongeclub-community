...
export default function SeolrokCertificate() {
  ...
  const giftMessages = [
    { sender: "Nina", message: "프로필 사진 너무 귀여워요 :) 이번주도 3조 화이팅입니당" },
    { sender: "치코", message: "셸 보내기 운동 화이팅입니다! 이번주 과제에서 인사이트 많이 나눠요" },
  ...
  const timeline = [
    ...
    {
      week: "3주차", date: "5/24",
      title: "자화상 — 매일 한 줄 기록 + 두 거울 AI 웹앱",
      summary: "매일 한 줄 던지면 AI가 짧게 비춰주는 개인 도구 '자화상'을 만들었어요. 병렬 2-에이전트(알아봄+다른 자리에서)와 순차 4-에이전트 회고 파이프라인을 구현했어요.",
      insight: "회고 기능을 안 만든 채 일기처럼 흘러갔는데, 이번 미션이 그 빠진 자리를 메워줬다.",
    },
    {
      week: "4주차", date: "5/31",
      title: "자화상 — 실사용 개선 + 비번 잠금 + 데모 분리",
      summary: "수정·삭제·하트·날짜 표시 등 실사용 중 필요해진 기능을 추가하고, 비밀번호 잠금과 공개 데모 사이트를 완전히 분리 배포했어요.",
      insight: "실사용이 진짜 설계자 — 머리로 기획한 게 아니라 직접 써보니 필요해진 것들.",
    },
    {
      week: "5주차", date: "6/7",
      title: "자화상 — '다른 결' 기능 + 디자인 리뉴얼",
      summary: "'다른 결로도 비춰볼까' 버튼을 눌러 다른 시점(오래된 친구→미래의 나)으로 한 번 더 비춰주는 기능을 추가했어요. 디자인 가이드 MD를 AI에 주고 따뜻한 톤으로 데모를 단장했어요.",
