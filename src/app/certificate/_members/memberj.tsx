...
export default function MemberJCertificate() {
  ...
  const giftMessages = [
    ...
    { sender: "Galia", message: "응원합니다~!!" },
    { sender: "하늘", message: "6조 화이팅입니다! ㅎㅎ" },
  ];
