...
export default function RinCertificate() {
  ...
  const giftMessages = [
    { sender: "4조 지니", message: "오늘은 과제 빨리 올리신 인에게~~" },
    { sender: "달빛그린", message: "6월 첫날 화이팅!!" },
      ...
      {hasDiploma && (
        <section className="bg-[var(--ink-05)] border-b border-[var(--ink-10)]">
          <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
            <div className="bg-[#FFFBEB] border-2 border-[#F59E0B] p-8 md:p-12 text-center relative"><RankBadge memberName="린(이은지)" />
