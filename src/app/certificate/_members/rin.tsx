...
export default function RinCertificate() {
  ...
  const timeline = [
    ...
    {
      week: "2주차", date: "5/17",
      title: "임린지 캐러셀 OS — 인스타 캐러셀 자동 생성 도구",
      summary: "비개발자가 Claude Code로 인스타 캐러셀 제작 OS를 한 세션에 처음부터 끝까지 만들었어요. 3분할 에디터 + AI 카피(Gemini) + AI 이미지 + Supabase 보관함까지 구현. Next.js 16이 깔려서 컨벤션 다시 학습하는 삽질부터, 모델 ID 헛다리, DB constraint 7번 마이그레이션까지 겪었어요.",
      insight: "추측하지 말고 물어봐가 시간을 아낀다. 캡처 한 장도 해석 갈림길이 많다.",
    },
    {
      week: "4주차", date: "5/31",
      title: "임린지 캐러셀 OS — 하네스 점검 + 디자인 틀 시스템",
      summary: "CLAUDE.md가 비어 있어서 매 세션 맥락을 모른 채 시작하던 문제를 발견하고 채워넣었어요. 디자인(색·폰트·로고)이 내 브랜드 하나에 코드로 박혀 있던 구조를 떼어내는 멀티브랜드 디자인 틀 시스템 1단계를 구현했어요.",
      insight: "CLAUDE.md는 매 세션 자동으로 읽히는 유일한 입구. 여기 한 곳만 채우면 PRD·디자인시스템·배포규칙이 한 번에 연결된다.",
    },
  ];
